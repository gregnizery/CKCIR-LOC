...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  .header-sep { height: 2.5px; background: #1B3A6B; margin: 8px 0 10px; }
  ...
  .section-title { background: #1B3A6B; color: #fff; padding: 4px 10px; font-weight: 700; font-size: 10pt; border-radius: 3px 3px 0 0; margin-top: 14px; }
  .section-body { border: 1px solid #CBD5E0; border-top: none; border-radius: 0 0 3px 3px; padding: 8px 10px; }
  ...
  .attestation-list li { margin-bottom: 3px; }
  table.membres { width: 100%; border-collapse: collapse; margin-top: 6px; font-size: 9.5pt; }
  table.membres th { background: #1B3A6B; color: #fff; text-align: left; padding: 5px 8px; }
  table.membres td { padding: 5px 8px; border-bottom: 1px solid #CBD5E0; vertical-align: middle; }
  ...
  .signature-final { margin-top: 16px; display: flex; justify-content: flex-end; align-items: flex-end; gap: 16px; }
...
<body>
  ...
  <div class="signature-final">
    ...
    <div class="box">
      ${location.signature_representant ? `<img src="${location.signature_representant}" />` : ''}
